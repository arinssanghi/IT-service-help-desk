...
public partial class admin_Home : System.Web.UI.Page
{
    ...
    {
        string sql="select * from Raised_Request";
        DataSet ds = new DataSet();
        ds = DAL.SqlHelper.ExecuteDataset(clsConnection.Connection, CommandType.Text, sql);

        lbl_POST.Text = ds.Tables[0].Rows.Count.ToString();

        string sql1 = "select * from Raised_Request where Status='Approved by PM'";
        ...
        string sql2 = "select * from Raised_Request where Status='Approved by NM'";
        ...
        string sql3 = "select * from Raised_Request where Status='Rejected by PM'";
        ...
        string sql4 = "select * from Raised_Request where Status='Rejected by NM'";
        ...
        string sql5 = "select * from Raised_Request where Status='Completed'";
        DataSet ds5 = new DataSet();
        ds5 = DAL.SqlHelper.ExecuteDataset(clsConnection.Connection, CommandType.Text, sql5);
        lbl_CMPLTD.Text = ds5.Tables[0].Rows.Count.ToString();


    }
    protected void lbl_POST_Click(object sender, EventArgs e)
    {
    ...
    protected void lbl_ANM_Click(object sender, EventArgs e)
    {
        ...
        string sql = "select * from Raised_request where Status='Approved by NM' ";
        DataSet ds = new DataSet();
        ds = DAL.SqlHelper.ExecuteDataset(clsConnection.Connection, CommandType.Text, sql);
        GDV.DataSource = ds;
        GDV.DataBind();
    ...
    protected void lbl_RPM_Click(object sender, EventArgs e)
    {
        ...
        string sql = "select * from Raised_request where Status='Rejected by NM' ";
        DataSet ds = new DataSet();
        ds = DAL.SqlHelper.ExecuteDataset(clsConnection.Connection, CommandType.Text, sql);
        GDV.DataSource = ds;
        GDV.DataBind();
    ...
    protected void lbl_RNM_Click(object sender, EventArgs e)
    {
        ...
        string sql = "select * from Raised_request where Status='Rejected by PM' ";
        DataSet ds = new DataSet();
        ds = DAL.SqlHelper.ExecuteDataset(clsConnection.Connection, CommandType.Text, sql);
        GDV.DataSource = ds;
        GDV.DataBind();
