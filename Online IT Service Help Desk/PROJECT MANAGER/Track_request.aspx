<%@ Page Language="C#" MasterPageFile="~/PROJECT MANAGER/Project_manager.master" AutoEventWireup="true" CodeFile="Track_request.aspx.cs" Inherits="PROJECT_MANAGER_Track_request" Title="Untitled Page" %>
        ...
        <tr>
            <td align="center">
                ...
                <asp:LinkButton ID="lnk_rjctdrqsts" runat="server" Font-Underline="False" 
                    >Click here to View rejected Requests</asp:LinkButton>
                <br />
                <br />
