...
public partial class Team_member_Raise_request : System.Web.UI.Page
{
    ...
    protected void snd_rqst_Click(object sender, EventArgs e)
    {
        ...
        string sql = "insert into Raised_request values('"+empid+"','"+request_for+"','"+request_description+"','Raised request','',getdate(),'')";
