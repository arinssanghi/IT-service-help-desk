<%@ Page Language="C#" MasterPageFile="~/Team_Member/Team_member.master" AutoEventWireup="true" CodeFile="Raise_request.aspx.cs" Inherits="Team_member_Raise_request" Title="Untitled Page" %>
        ...
        <td>
            <table align="center" cellpadding="0" cellspacing="0" class="style18">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <asp:TextBox ID="txt_rqstdscrptn" runat="server" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
