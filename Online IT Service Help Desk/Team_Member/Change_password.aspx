<%@ Page Language="C#" MasterPageFile="~/Team_Member/Team_member.master" AutoEventWireup="true" CodeFile="Change_password.aspx.cs" Inherits="Team_member_Change_password" Title="Untitled Page" %>
                    ...
                    <tr>
                        ...
                        <td class="style20">
                            <asp:Button ID="chng_pswrd" runat="server" 
                                Text="Update" ValidationGroup="CMPRE" Width="73px" onclick="chng_pswrd_Click1" 
                                 />
                        </td>
                        <td class="style21">
                            &nbsp;</td>
